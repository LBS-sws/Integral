...
if (empty($model->activity_id)){
    $this->redirect(Yii::app()->createUrl('addIntegral/index'));
}
$this->pageTitle=Yii::app()->name . ' - addIntegral Form';
?>
