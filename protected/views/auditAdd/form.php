...
$this->pageTitle=Yii::app()->name . ' - auditAdd Info';
?>
...
?>
<?php
$this->renderPartial('//site/ject',array('model'=>$model,'form'=>$form,'rejectName'=>"reject_note",'submit'=>Yii::app()->createUrl('auditAdd/reject')));
?>
<?php
