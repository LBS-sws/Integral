...
<section class="content-header">
	<h1>
		<strong><?php echo Yii::t('integral','Cut activities Form'); ?></strong>
	</h1>
<!--
	<ol class="breadcrumb">
...
<section class="content">
	...
	<div class="btn-group" role="group">
		<?php echo TbHtml::button('<span class="fa fa-reply"></span> '.Yii::t('misc','Back'), array(
				'submit'=>Yii::app()->createUrl('activityCut/index')));
		?>
<?php if ($model->scenario!='view'): ?>
			<?php
            echo TbHtml::button('<span class="fa fa-file-o"></span> '.Yii::t('misc','Add'), array(
                'submit'=>Yii::app()->createUrl('activityCut/new'),
            ));
            echo TbHtml::button('<span class="fa fa-upload"></span> '.Yii::t('misc','Save'), array(
				'submit'=>Yii::app()->createUrl('activityCut/save')));
			?>
<?php endif ?>
        <?php if ($model->scenario=='edit'): ?>
            <?php echo TbHtml::button('<span class="fa fa-remove"></span> '.Yii::t('misc','Delete'), array(
                'submit'=>Yii::app()->createUrl('activityCut/delete')));
            ?>
        <?php endif ?>
	</div>
	</div></div>
...
if ($model->scenario!='view') {
    $js = Script::genDatePicker(array(
        'ActivityCutForm_start_time',
        'ActivityCutForm_end_time',
    ));
