...
class AuditAddForm extends CFormModel
{
    /* User Fields */
    public $id = 0;
    public $employee_id;
    ...
    {
        return array(
            array('id, employee_id, employee_name, activity_id, set_id, integral, images_url, remark, reject_note, reject_note, lcu, luu, lcd, lud','safe'),
    ...
    public function retrieveData($index) {
        ...
        $rows = Yii::app()->db->createCommand()->select("a.*,d.integral_type,d.s_remark,b.name as employee_name,docman$suffix.countdoc('GRAL',a.id) as graldoc")->from("gr_gral_add a")
